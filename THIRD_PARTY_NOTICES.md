...
- **BeeJoseph/smoothie-generator**
  ...
  - License: MIT.
- **gayusri-ds/Ingredients-Based-Diet-Recipe-Recommendation-System**
...
repository. If code is reused later, the corresponding copyright and license
notices must be preserved as required by the source license.

## Unlicensed reference

- **MangoProductions/SmoothieGeneratorHeuristic**
  - May be considered only for high-level conceptual inspiration while no
    compatible license is present.
  - Source code must not be copied into this repository without explicit
